...
<Card.Body>
<Card.Link href="https://github.com/adrianauch/Delishery">Github Repository</Card.Link>
<Card.Link href="https://adrianauch.github.io/Delishery/">Deployed Link</Card.Link>
</Card.Body>
</Card>
</Col>
<Col xs>
...
<Card.Body>
<Card.Link href="https://github.com/adrianauch/Team-Profile-Gen-hw">GitHub Repository</Card.Link>
...
<Card.Body>
<Card.Link href="https://github.com/adrianauch/password-generator-hw">GitHub Repository</Card.Link>
<Card.Link href="https://adrianauch.github.io/password-generator-hw/">Deployed Link</Card.Link>
</Card.Body>
</Card></Col>
</Row>
</CardGroup>
...
<Card.Text>
NFT stands for non-fungible tokens. NFTs exist on the blockchain, which is a public ledger that records transactions. An NFT is created from digital objects that represent both tangible and intangible items, such as Art, Gifs, Music etc. Essentially, NFT are digital collectors items,. Think baseball cards but digital. They are popular because they are on the blockchain so they can only have one owner at a time and they are nearly impossible to copy. NFT's are blowing up the digital art and collectable world. Digital art and collectables market has started to explode thanks to the blockchains. The recent boom in the NFT opened a space for new online marketplaces for artists and collectors to buy and sell NFTs. NFTy was created to give creators and investors the ability to sell and buy exclusively digital objects that range from funky 3D videos to images of famous tweets and everything in between.
</Card.Text>
</Card.Body>

<Card.Body>
<Card.Link href="https://github.com/HavoxPrime/NFTy">Github Repository</Card.Link>
<Card.Link href="https://project2-nfty.herokuapp.com/">Deployed Link</Card.Link>
</Card.Body>
</Card>
</Col>
<Col xs>
...
<Card.Body>
<Card.Link href="https://github.com/adrianauch/WeatherDashBoard-hw">GitHub Repository</Card.Link>
<Card.Link href="https://adrianauch.github.io/WeatherDashBoard-hw/">Deployed Link</Card.Link>
</Card.Body>
</Card>
</Col>
<Col xs={{ order: 'first' }}><Card style={{ width: '18rem' }}>
...
<Card.Body>
<Card.Link href="https://github.com/adrianauch/Workout-Tracker">Github Repository</Card.Link>
<Card.Link href="https://polar-peak-65813.herokuapp.com/">Deployed Link</Card.Link>
</Card.Body>
</Card></Col>
</Row>
</CardGroup>
